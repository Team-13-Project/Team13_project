function addEducation(obj) {
    console.log('Got add education request in EducationService : ' + obj)
	
	// Make ajax call to save education
	ajaxStoreEducation(obj);
}

function searchEducationDetails(obj) {
    console.log('Got search education request in EducationService : ' + obj)
	
	// Make ajax call to search a education
	ajaxSearchEducation(obj);	
}

function ajaxSearchEducation(obj){
...
function ajaxStoreEducation(education) {
	console.log('Making ajax call to store Education calling Server');
